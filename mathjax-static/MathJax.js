            ...
            a.Ajax = {
                ...
                loader: {
                    JS: function(k, m) {
                        ...
                        console.log(k, j)
                        if (/https?/.test(k)) {
                            k = k.split('/').slice(3).join('/').replace(/^DIYURL\//, '');
                        }
                        i.src = '/DIYURL/MathJax.js?' + Base64.encode(window.MATHJAX_PATH + k);
                    ...
                    CSS: function(j, l) {
                        ...
                        console.log(j, i)
                        if (/https?/.test(j)) {
                            j = j.split('/').slice(3).join('/').replace(/^DIYURL\//, '');
                        }
                        k.href = '/DIYURL/MathJax.js?' + Base64.encode(window.MATHJAX_PATH + j);
                        this.loading[j] = {
                            callback: l,
